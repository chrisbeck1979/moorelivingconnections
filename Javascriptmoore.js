! function(e, t) {
    ...
    function c(e, t, n, r) {
        if (it.acceptData(e)) {
            var i, o, a = it.expando,
                ...
                l = s ? it.cache : e,
                u = s ? e[a] : e[a] && a;
            if (u && l[u] && (r || l[u].data) || void 0 !== n || "string" != typeof t) return u || (u = s ? e[a] = Q.pop() || it.guid++ : a), l[u] || (l[u] = s ? {} : {
                    toJSON: it.noop
    ...
    function I(e, t, n, r) {
        ...
        if (it.isArray(t)) it.each(t, function(t, i) {
            n || Qn.test(e) ? r(e, i) : I(e + "[" + ("object" == typeof i ? t : "") + "]", i, n, r)
        });
    ...
    var ut = function(e) {
            ...
            if (!r && _) {
                ...
                if (w.qsa && (!M || !M.test(e))) {
                    if (p = d = B, h = t, m = 1 !== s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                        for (u = E(e), (d = t.getAttribute("id")) ? p = d.replace(bt, "\\$&") : t.setAttribute("id", p), p = "[id='" + p + "'] ", l = u.length; l--;) u[l] = p + f(u[l]);
                        h = xt.test(e) && c(t.parentNode) || t, m = u.join(",")
                    }
                    if (m) try {
        ...
        function v(e, t, n, i, o, a) {
            return i && !i[B] && (i = v(i)), o && !o[B] && (o = v(o, a)), r(function(r, a, s, l) {
                var u, c, d, f = [],
                    ...
                    x = n ? o || (r ? e : h || i) ? [] : a : y;
                if (n && n(y, x, s, l), i)
                    for (u = g(x, p), i(u, [], s, l), c = u.length; c--;)(d = u[c]) && (x[p[c]] = !(y[p[c]] = d));
                if (r) {
                    if (o || e) {
                        if (o) {
                        ...
                        for (c = x.length; c--;)(d = x[c]) && (u = o ? et(r, d) : f[c]) > -1 && (r[u] = !(a[u] = d))
                    }
            ...
            var i = n.length > 0,
                ...
                a = function(r, a, s, l, u) {
                    var c, d, f, p = 0,
                        ...
                        w = x.length;
                    for (u && (A = a !== H && a); h !== w && null != (c = x[h]); h++) {
                        if (o && c) {
                            for (d = 0; f = e[d++];)
                                if (f(c, a, s)) {
                                    l.push(c);
        ...
        var b, w, T, C, N, E, k, S, A, j, D, L, H, q, _, M, F, O, $, B = "sizzle" + 1 * new Date,
            P = e.document,
            R = 0,
            W = 0,
            z = n(),
        ...
        w = t.support = {}, N = t.isXML = function(e) {
            ...
            return r !== H && 9 === r.nodeType && r.documentElement ? (H = r, q = r.documentElement, n = r.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ct, !1) : n.attachEvent && n.attachEvent("onunload", Ct)), _ = !N(r), w.attributes = i(function(e) {
                    ...
                    }), M = M.length && new RegExp(M.join("|")), F = F.length && new RegExp(F.join("|")), t = vt.test(q.compareDocumentPosition), $ = t || vt.test(q.contains) ? function(e, t) {
                    ...
                    return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === r || e.ownerDocument === P && $(P, e) ? -1 : t === r || t.ownerDocument === P && $(P, t) ? 1 : j ? et(j, e) - et(j, t) : 0 : 4 & n ? -1 : 1)
                } : function(e, t) {
                    if (e === t) return D = !0, 0;
                    var n, i = 0,
                        o = e.parentNode,
            ...
            var n = T.attrHandle[t.toLowerCase()],
                r = n && Q.call(T.attrHandle, t.toLowerCase()) ? n(e, t, !_) : void 0;
        ...
        return d.prototype = T.filters = T.pseudos, T.setFilters = new d, E = t.tokenize = function(e, n) {
            ...
            if (n = n || [], 1 === d.length) {
                ...
                for (i = ht.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !T.relative[s = a.type]);)
                    if ((l = T.find[s]) && (r = l(a.matches[0].replace(wt, Tt), xt.test(o[0].type) && c(t.parentNode) || t))) {
                        if (o.splice(i, 1), e = r.length && f(o), !e) return K.apply(n, r), n;
                        break
                    }
            }
            return (u || k(e, d))(r, t, !_, n, xt.test(e) && c(t.parentNode) || t), n
        ...
        add: function(e, t, n, r, i) {
            ...
            if (g) {
                for (n.handler && (l = n, n = l.handler, i = l.selector), n.guid || (n.guid = it.guid++), (a = g.events) || (a = g.events = {}), (c = g.handle) || (c = g.handle = function(e) {
                        ...
                        }, c.elem = e), t = (t || "").match(xt) || [""], s = t.length; s--;) o = Mt.exec(t[s]) || [], p = m = o[1], h = (o[2] || "").split(".").sort(), p && (u = it.event.special[p] || {}, p = (i ? u.delegateType : u.bindType) || p, u = it.event.special[p] || {}, d = it.extend({
                            type: p,
                            origType: m,
                            data: r,
                            handler: n,
    ...
    Jt.optgroup = Jt.option, Jt.tbody = Jt.tfoot = Jt.colgroup = Jt.caption = Jt.thead, Jt.th = Jt.td, it.extend({
            clone: function(e, t, n) {
                ...
                if (nt.html5Clone || it.isXMLDoc(e) || !$t.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Gt.innerHTML = e.outerHTML, Gt.removeChild(o = Gt.firstChild)), !(nt.noCloneEvent && nt.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || it.isXMLDoc(e)))
            ...
            cleanData: function(e, t) {
                for (var n, r, i, o, a = 0, s = it.expando, l = it.cache, u = nt.deleteExpando, c = it.event.special; null != (n = e[a]); a++)
                    if ((t || it.acceptData(n)) && (i = n[s], o = i && l[i])) {
                        ...
                        l[i] && (delete l[i], u ? delete n[s] : typeof n.removeAttribute !== Ct ? n.removeAttribute(s) : n[s] = null, Q.push(i))
                    }
            }
        }), it.fn.extend({
            text: function(e) {
            ...
            html: function(e) {
                return jt(this, function(e) {
                    ...
                    if (!("string" != typeof e || It.test(e) || !nt.htmlSerialize && $t.test(e) || !nt.leadingWhitespace && Bt.test(e) || Jt[(Rt.exec(e) || ["", ""])[1].toLowerCase()])) {
                        e = e.replace(Pt, "<$1></$2>");
                        try {
            ...
            domManip: function(e, t) {
                ...
                if (u && (s = it.buildFragment(e, this[0].ownerDocument, !1, this), n = s.firstChild, 1 === s.childNodes.length && (s = n), n)) {
                    for (o = it.map(g(s, "script"), x), i = o.length; u > l; l++) r = s, l !== d && (r = it.clone(r, !0, !0), i && it.merge(o, g(r, "script"))), t.call(this[l], r, l);
                    if (i)
                        for (a = o[o.length - 1].ownerDocument, it.map(o, b), l = 0; i > l; l++) r = o[l], Ut.test(r.type || "") && !it._data(r, "globalEval") && it.contains(a, r) && (r.src ? it._evalUrl && it._evalUrl(r.src) : it.globalEval((r.text || r.textContent || r.innerHTML || "").replace(Qt, "")));
                    s = n = null
                }
                return this
            }
    ...
    it.fn.extend({
            ...
            toggleClass: function(e, t) {
                ...
                return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(it.isFunction(e) ? function(n) {
                    ...
                    if ("string" === n)
                        for (var t, r = 0, i = it(this), o = e.match(xt) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
    ...
    _n = Wn.exec(Mn.toLowerCase()) || [], it.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ajaxSettings: {
            ...
            ajax: function(e, t) {
                ...
                if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, d.url = ((e || d.url || Mn) + "").replace(Fn, "").replace(Rn, _n[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = it.trim(d.dataType || "*").toLowerCase().match(xt) || [""], null == d.crossDomain && (r = Wn.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] === _n[1] && r[2] === _n[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (_n[3] || ("http:" === _n[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = it.param(d.data, d.traditional)), P(zn, d, t, w), 2 === x) return w;
        ...
        return r.join("&").replace(Vn, "+")
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    var e = this.type;
                    return this.name && !it(this).is(":disabled") && Gn.test(this.nodeName) && !Yn.test(e) && (this.checked || !Dt.test(e))
                }).map(function(e, t) {
                    var n = it(this).val();
    ...
    jQuery(window).scrollTop() > 150 ? jQuery("#backtotop").addClass("visible") : jQuery("#backtotop").removeClass("visible")
}), $('<form action="#"><select /></form>').appendTo("#mainav"), $("<option />", {
        selected: "selected",
        value: "",
        text: "MENU"
    }).appendTo("#mainav select"), $("#mainav a").each(function() {
        var e = $(this);
        $(e).parents("ul ul ul").length >= 1 ? $("<option />", {
                value: e.attr("href"),
                text: "- - - " + e.text()
            }).appendTo("#mainav select") : $(e).parents("ul ul").length >= 1 ? $("<option />", {
                value: e.attr("href"),
                text: "- - " + e.text()
            }).appendTo("#mainav select") : $(e).parents("ul").length >= 1 ? $("<option />", {
                value: e.attr("href"),
                text: "" + e.text()
            }).appendTo("#mainav select") : $("<option />", {
                value: e.attr("href"),
                text: e.text()
            }).appendTo("#mainav select")
    }), $("#mainav select").change(function() {
        "#" !== $(this).find("option:selected").val() && (window.location = $(this).find("option:selected").val())
    });
